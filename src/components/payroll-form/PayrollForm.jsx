...
const PayrollForm =(pros)=>{
    let initialValue={
        name:"",
        profileArray:[
            { url: '../../assets/img/profile1.png' },
            { url: '../../assets/img/profile2.png' },
            { url: '../../assets/img/profile3.png' },
            { url: '../../assets/img/profile4.png' }
        ],
        allDepartment: [
                ...
                <form className="form" action="#" onSubmit={save}>
                    ...
                    <div className="row">
                        ...
                        <div className="profile-radio-button">
                            <label >
                                <input type="radio" name="profileUrl" checked={formValue.profileUrl === '../../assets/img/profile1.png'} value='../../assets/img/profile1.png' onChange={changeValue} />
                                <img className="profile" src={profile1} alt="profile" />
                            </label>
                            <label >
                                <input type="radio" name="profileUrl" checked={formValue.profileUrl === '../../assets/img/profile2.png'} value='../../assets/img/profile2.png' onChange={changeValue} />
                                <img className="profile" src={profile2} alt="profile" />
                            </label>
                            <label >
                                <input type="radio" name="profileUrl" checked={formValue.profileUrl === '../../assets/img/profile3.png'} value='../../assets/img/profile3.png' onChange={changeValue} />
                                <img className="profile" src={profile3} alt="profile" />
                            </label>
                            <label >
                                <input type="radio" name="profileUrl" checked={formValue.profileUrl === '../../assets/img/profile4.png'} value='../../assets/img/profile4.png' onChange={changeValue} />
